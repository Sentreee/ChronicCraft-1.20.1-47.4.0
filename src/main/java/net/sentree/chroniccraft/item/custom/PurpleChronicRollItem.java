...
public class PurpleChronicRollItem extends Item {

    public PurpleChronicRollItem(Properties properties) {
        super(properties);
    }
    ...
    public ItemStack finishUsingItem(ItemStack stack, Level level, LivingEntity entity) {
        if (!level.isClientSide) {
            entity.addEffect(new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 3600, 3));
