...
public class ChilliPChronicRollItem extends Item {

    public ChilliPChronicRollItem(Properties properties) {
        super(properties);
    }
    ...
    public ItemStack finishUsingItem(ItemStack stack, Level level, LivingEntity entity) {
        if (!level.isClientSide) {
            entity.addEffect(new MobEffectInstance(MobEffects.FIRE_RESISTANCE, 3600, 3));
